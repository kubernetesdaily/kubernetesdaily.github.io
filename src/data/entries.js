...
export const entries = [
  ...
  {title: "KubeStellar Console",
    ...
    description: "AI-powered multi-cluster Kubernetes console with natural-language chat, GitOps deploy missions, real-time dashboard, and MCP server (kc-agent) for programmatic cluster control",
    github: "kubestellar",
    tag: "Cluster Management"},
  {title: "Trolley",
  ...
  {title: "Polaris",
    ...
    tag: "Development Tools"},
  {title: "Cluster API",
    link: "https://cluster-api.sigs.k8s.io/",
    description: "Kubernetes sub-project for declarative provisioning, upgrade, and operation of Kubernetes clusters",
    github: "kubernetes-sigs/cluster-api",
    tag: "Cluster Management"},
  {title: "K3s",
    link: "https://k3s.io/",
    description: "Lightweight, certified Kubernetes distribution built for IoT and edge computing",
    github: "k3s-io/k3s",
    tag: "Cluster Management"},
  {title: "Talos Linux",
    link: "https://www.talos.dev/",
    description: "Modern, secure, immutable, and minimal Linux OS purpose-built for running Kubernetes",
    github: "siderolabs/talos",
    tag: "Cluster Management"},
  {title: "MicroK8s",
    link: "https://microk8s.io/",
    description: "Low-ops, minimal production Kubernetes for developers, edge, and IoT from Canonical",
    github: "canonical/microk8s",
    tag: "Cluster Management"},
  {title: "KubeVirt",
    link: "https://kubevirt.io/",
    description: "Run virtual machines alongside containers on Kubernetes using a Custom Resource API",
    github: "kubevirt/kubevirt",
    tag: "Cluster Management"},
  {title: "KubeEdge",
    link: "https://kubeedge.io/",
    description: "Kubernetes-native edge computing framework that extends container orchestration to edge nodes",
    github: "kubeedge/kubeedge",
    tag: "Cluster Management"},
  {title: "Kubernetes Dashboard",
    link: "https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/",
    description: "General-purpose, web-based UI for Kubernetes clusters maintained by the Kubernetes project",
    github: "kubernetes/dashboard",
    tag: "Cluster Management"},
  {title: "Headlamp",
    link: "https://headlamp.dev/",
    description: "Extensible Kubernetes web UI and desktop app, a CNCF sandbox project",
    github: "headlamp-k8s/headlamp",
    tag: "Cluster Management"},
  {title: "KubeVela",
    link: "https://kubevela.io/",
    description: "Modern application delivery platform built on top of Kubernetes and Open Application Model",
    github: "kubevela/kubevela",
    tag: "Platform Engineering"},
  {title: "containerd",
    link: "https://containerd.io/",
    description: "Industry-standard container runtime emphasizing simplicity, robustness, and portability",
  ...
  {title: "Harbor",
    ...
    description: "Open source, trusted cloud-native container registry that stores, signs, and scans images",
  ...
  {title: "Buildah",
    ...
    description: "Tool that facilitates building OCI container images without requiring a daemon",
    github: "containers/buildah",
    tag: "Development Tools"},
  {title: "BuildKit",
    link: "https://github.com/moby/buildkit",
    description: "Toolkit for converting source code to build artifacts in an efficient, expressive way",
    github: "moby/buildkit",
    tag: "Development Tools"},
  {title: "Skopeo",
    link: "https://github.com/containers/skopeo",
    description: "Command line utility for performing operations on container images and image repositories",
    github: "containers/skopeo",
    tag: "Development Tools"},
  {title: "Dive",
    link: "https://github.com/wagoodman/dive",
    description: "Tool for exploring a docker image, layer contents, and discovering ways to shrink the size",
  ...
  {title: "CoreDNS",
    ...
    description: "Cloud-native DNS server, fast and flexible, with a focus on service discovery",
    github: "coredns/coredns",
    tag: "Networking"},
  {title: "Strimzi",
    link: "https://strimzi.io/",
    description: "Provides a way to run an Apache Kafka cluster on Kubernetes in various deployment configurations",
    github: "strimzi/strimzi-kafka-operator",
    tag: "Cluster Management"},
  {title: "Envoy",
    link: "https://www.envoyproxy.io/",
    description: "Cloud-native, high-performance edge, middle, and service proxy graduated from CNCF",
    github: "envoyproxy/envoy",
    tag: "Network & Service Mesh"},
  {title: "Consul",
    link: "https://www.consul.io/",
    description: "Service networking platform from HashiCorp providing service discovery, mesh, and config",
    github: "hashicorp/consul",
    tag: "Network & Service Mesh"},
  {title: "Kuma",
    link: "https://kuma.io/",
    description: "Universal service mesh for Kubernetes, VMs, and bare metal, built on Envoy",
    github: "kumahq/kuma",
    tag: "Service Mesh"},
  {title: "Traefik",
    link: "https://traefik.io/traefik/",
    description: "Modern HTTP reverse proxy and load balancer that integrates with major cluster technologies",
    github: "traefik/traefik",
    tag: "Networking"},
  {title: "Calico",
    link: "https://www.tigera.io/project-calico/",
    description: "Open source networking and security solution for containers, VMs, and native host workloads",
    github: "projectcalico/calico",
    tag: "Networking"},
  {title: "Hubble",
    link: "https://github.com/cilium/hubble",
    description: "Network, service, and security observability for Kubernetes built on top of Cilium and eBPF",
    github: "cilium/hubble",
    tag: "Monitoring & Observability"},
  {title: "Submariner",
    link: "https://submariner.io/",
    description: "Tool that enables direct networking between pods and services in different Kubernetes clusters",
    github: "submariner-io/submariner",
    tag: "Networking"},
  {title: "Antrea",
    link: "https://antrea.io/",
    description: "Kubernetes networking solution intended to be Kubernetes native, leveraging Open vSwitch",
    github: "antrea-io/antrea",
    tag: "Networking"},
  {title: "Contour",
    link: "https://projectcontour.io/",
    description: "Kubernetes ingress controller using the Envoy reverse proxy as a data plane",
  ...
  {title: "Cosign",
    ...
    description: "Container signing, verification, and storage in an OCI registry, part of the Sigstore project",
    github: "sigstore/cosign",
    tag: "Security Tools"},
  {title: "Gatekeeper",
    link: "https://open-policy-agent.github.io/gatekeeper/",
    description: "Policy controller for Kubernetes that integrates Open Policy Agent with the admission controller",
    github: "open-policy-agent/gatekeeper",
    tag: "Security Tools"},
  {title: "KubeArmor",
    link: "https://kubearmor.io/",
    description: "Cloud-native runtime security enforcement system that restricts behavior of pods and containers",
    github: "kubearmor/KubeArmor",
    tag: "Security Tools"},
  {title: "Tracee",
    link: "https://aquasecurity.github.io/tracee/latest/",
    description: "Runtime security and forensics tool for Linux using eBPF technology to detect suspicious events",
    github: "aquasecurity/tracee",
    tag: "Security Tools"},
  {title: "Checkov",
    link: "https://www.checkov.io/",
    description: "Static analysis tool for infrastructure as code, supporting Terraform, Kubernetes, Helm, and more",
    github: "bridgecrewio/checkov",
    tag: "Security Tools"},
  {title: "Notation",
    link: "https://notaryproject.dev/",
    description: "CLI for signing and verifying OCI artifacts and container images, part of the Notary Project",
    github: "notaryproject/notation",
    tag: "Security Tools"},
  {title: "SPIRE",
    link: "https://spiffe.io/docs/latest/spire-about/",
    description: "Production-ready implementation of the SPIFFE APIs for workload identity",
    github: "spiffe/spire",
    tag: "Security Tools"},
  {title: "Grype",
    link: "https://github.com/anchore/grype",
    description: "Vulnerability scanner for container images and filesystems with first-class SBOM support",
  ...
  {title: "KICS",
    link: "https://kics.io/",
    description: "Find security vulnerabilities, compliance issues, and infrastructure misconfigurations in IaC",
    github: "Checkmarx/kics",
    tag: "Security Tools"},
  {title: "Tempo",
    link: "https://grafana.com/oss/tempo/",
    description: "High-volume distributed tracing backend from Grafana Labs, integrated with Prometheus and Loki",
    github: "grafana/tempo",
    tag: "Logging and Tracing"},
  {title: "Mimir",
    link: "https://grafana.com/oss/mimir/",
  ...
  {title: "Cortex",
    ...
    description: "Horizontally scalable, highly available, multi-tenant, long term storage for Prometheus",
    github: "cortexproject/cortex",
    tag: "Monitoring & Observability"},
  {title: "Pyroscope",
    link: "https://grafana.com/oss/pyroscope/",
    description: "Continuous profiling platform from Grafana Labs to debug performance issues down to a line of code",
    github: "grafana/pyroscope",
    tag: "Monitoring & Observability"},
  {title: "SigNoz",
    link: "https://signoz.io/",
    description: "Open source observability platform with metrics, traces, and logs in a single application",
  ...
  {title: "Vector",
    ...
    description: "High-performance observability data pipeline for collecting, transforming, and routing logs and metrics",
    github: "vectordotdev/vector",
    tag: "Logging and Tracing"},
  {title: "Fluentd",
    link: "https://www.fluentd.org/",
    description: "Open source data collector for unified logging layer, a CNCF graduated project",
    github: "fluent/fluentd",
    tag: "Logging and Tracing"},
  {title: "Zipkin",
    link: "https://zipkin.io/",
    description: "Distributed tracing system that helps gather timing data needed to troubleshoot latency problems",
    github: "openzipkin/zipkin",
    tag: "Logging and Tracing"},
  {title: "Robusta",
    link: "https://home.robusta.dev/",
    description: "Open source platform for Kubernetes troubleshooting that automates root cause analysis with Prometheus alerts",
    github: "robusta-dev/robusta",
    tag: "Monitoring & Observability"},
  {title: "Helm",
    link: "https://helm.sh/",
    description: "The package manager for Kubernetes, a CNCF graduated project",
    github: "helm/helm",
    tag: "Development Tools"},
  {title: "Kustomize",
    link: "https://kustomize.io/",
    description: "Customize raw, template-free YAML files for multiple purposes, leaving the original YAML untouched",
    github: "kubernetes-sigs/kustomize",
    tag: "Development Tools"},
  {title: "Argo Rollouts",
    link: "https://argo-rollouts.readthedocs.io/",
    description: "Progressive delivery controller for Kubernetes supporting blue-green, canary, and experimentation",
    github: "argoproj/argo-rollouts",
    tag: "CI/CD Tools"},
  {title: "Argo Workflows",
    link: "https://argo-workflows.readthedocs.io/",
    description: "Container-native workflow engine for orchestrating parallel jobs on Kubernetes",
    github: "argoproj/argo-workflows",
    tag: "CI/CD Tools"},
  {title: "Argo Events",
    link: "https://argoproj.github.io/argo-events/",
    description: "Event-driven workflow automation framework for Kubernetes that integrates with many event sources",
    github: "argoproj/argo-events",
    tag: "CI/CD Tools"},
  {title: "Flagger",
    link: "https://flagger.app/",
    description: "Progressive delivery operator for Kubernetes that automates canary releases with metrics analysis",
    github: "fluxcd/flagger",
    tag: "CI/CD Tools"},
  {title: "Spinnaker",
    link: "https://spinnaker.io/",
    description: "Open source, multi-cloud continuous delivery platform that combines a powerful pipeline engine with integrations",
    github: "spinnaker/spinnaker",
    tag: "Continuous Integration & Delivery"},
  {title: "Drone",
    link: "https://www.drone.io/",
    description: "Container-native, continuous delivery platform built on Docker, written in Go",
    github: "harness/drone",
    tag: "Continuous Integration & Delivery"},
  {title: "Werf",
    link: "https://werf.io/",
    description: "Open source GitOps CLI tool to make CI/CD work with Git, Docker, Helm, and Kubernetes",
    github: "werf/werf",
    tag: "CI/CD Tools"},
  {title: "Keptn",
    link: "https://keptn.sh/",
    description: "Cloud-native application lifecycle orchestration toolkit for delivery and operations automation",
    github: "keptn/keptn",
    tag: "CI/CD Tools"},
  {title: "MinIO",
    link: "https://min.io/",
    description: "High-performance, S3-compatible object storage suite designed for large-scale private cloud infrastructure",
    github: "minio/minio",
    tag: "Storage"},
  {title: "Velero",
    link: "https://velero.io/",
    description: "Open source tool to back up, restore, perform disaster recovery, and migrate Kubernetes cluster resources",
    github: "vmware-tanzu/velero",
    tag: "Backup Tools"},
  {title: "Vitess",
    link: "https://vitess.io/",
    description: "Database clustering system for horizontal scaling of MySQL, a CNCF graduated project",
  ...
  {title: "Volcano",
    ...
    description: "Cloud-native batch system for high-performance workloads such as AI, machine learning, and big data on Kubernetes",
    github: "volcano-sh/volcano",
    tag: "Machine Learning"},
  {title: "Tinkerbell",
    link: "https://tinkerbell.org/",
    description: "Bare metal provisioning engine that allows you to provision physical machines using Kubernetes-native tooling",
    github: "tinkerbell/tink",
    tag: "Cluster Management"},
  {title: "Cloud Custodian",
    link: "https://cloudcustodian.io/",
    description: "Rules engine for cloud security, cost optimization, and governance with DSL in YAML for policies across cloud providers",
    github: "cloud-custodian/cloud-custodian",
    tag: "Cost Optimization"},
  {title: "BentoML",
    link: "https://bentoml.com/",
    description: "Unified model serving framework that simplifies building production-ready AI applications",
    github: "bentoml/BentoML",
    tag: "Machine Learning"},
  {title: "MLflow",
    link: "https://mlflow.org/",
    description: "Open source platform for the end-to-end machine learning lifecycle, including tracking and model registry",
    github: "mlflow/mlflow",
    tag: "Machine Learning"},
  {title: "Feast",
    link: "https://feast.dev/",
    description: "Open source feature store for machine learning that enables teams to share, discover, and serve features",
  ...
  {title: "LiteLLM",
    ...
    description: "LLM gateway that calls 100+ LLM APIs in the OpenAI format with consistent input/output mapping",
    github: "BerriAI/litellm",
    tag: "Artificial Intelligence"},
  {title: "LocalAI",
    link: "https://localai.io/",
    description: "Free, open source, drop-in replacement for OpenAI APIs that runs LLMs locally on consumer-grade hardware",
    github: "mudler/LocalAI",
    tag: "Artificial Intelligence"},
  {title: "Ollama",
    link: "https://ollama.com/",
    description: "Get up and running with large language models locally with a simple CLI and REST API",
    github: "ollama/ollama",
    tag: "Artificial Intelligence"},
  {title: "Open WebUI",
    link: "https://openwebui.com/",
    description: "Extensible, self-hosted AI interface that adapts to your workflow, working with Ollama and OpenAI-compatible APIs",
    github: "open-webui/open-webui",
    tag: "Artificial Intelligence"},
  {title: "Dify",
    link: "https://dify.ai/",
    description: "Open source platform for developing LLM applications, combining backend-as-a-service and LLMOps",
    github: "langgenius/dify",
    tag: "Artificial Intelligence"},
  {title: "KAITO",
    link: "https://github.com/kaito-project/kaito",
    description: "Kubernetes AI Toolchain Operator that automates AI/ML model deployment in Kubernetes clusters",
    github: "kaito-project/kaito",
    tag: "Artificial Intelligence"},
  {title: "Fission",
    link: "https://fission.io/",
    description: "Fast and simple serverless functions framework for Kubernetes with native support for many languages",
    github: "fission/fission",
    tag: "Serverless/FaaS"},
  {title: "Kanister",
    link: "https://kanister.io/",
    description: "Application-level data protection framework for Kubernetes that supports backup and recovery workflows",
    github: "kanisterio/kanister",
    tag: "Backup Tools"},
  {title: "Capsule",
    link: "https://projectcapsule.dev/",
    description: "Multi-tenancy and policy-based framework for Kubernetes, a CNCF sandbox project",
    github: "projectcapsule/capsule",
    tag: "Cluster Management"},
  {title: "Pack",
    link: "https://buildpacks.io/",
    description: "CLI for building apps using Cloud Native Buildpacks, a CNCF incubating project",
    github: "buildpacks/pack",
    tag: "Development Tools"},
  {title: "in-toto",
    link: "https://in-toto.io/",
    description: "Framework to secure the integrity of software supply chains, a CNCF incubating project",
